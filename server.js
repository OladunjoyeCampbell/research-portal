...
//                         ADMIN_PASSWORD, SESSION_SECRET, NODE_ENV
// ══════════════════════════════════════════════════════════════
...
// ── Trust proxy (required for Render because it uses a reverse proxy)
app.set('trust proxy', 1);

// ── CORS: allow credentials and specific origins (GitHub Pages + local)
const allowedOrigins = [
  'https://oladunjoyecampbell.github.io',
  'http://localhost:8080',
  'http://localhost:3000'
];
app.use(cors({
...
// ── Session middleware (secure cross-origin)
app.use(session({
